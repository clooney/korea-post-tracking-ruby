# Korea Post Tracking API For Ruby
Korea Post Tracking API and webhook make it easy to integrate Korea Post Tracking function into your own project. Support APIs Client Libraries for ruby

### API key

In order to use this API, you need to generate a Korea Post Tracking  API key in the [TrackingMore](https://www.trackingmore.com).
...
------------------------------------------------------------------------------------------------------------------
[TrackingMore](https://www.trackingmore.com) is a multiple carrier solutions. Developers can get tracking results from 410+ couriers by integrating trackingmore API.Check the courier code. use Korea Post Tracking API of Trackingmore  allows eCommerce developers in any sizes to add package tracking fuction easily. Use [Korea Post Tracking API](https://www.trackingmore.com/korea-post-tracking.html)  to:

   *   Get Korea Post realtime tracking info of muti-carriers in one integration
   *   Provide Korea Post shipment tracking experience like Amazon
   *   Push Korea Post notifications of package update with webhook
   *   Verify Korea Post delivery exception before it is too late
